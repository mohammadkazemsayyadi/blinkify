...
chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
  ...
  if (msg.type === 'updateSettings') {
    settings.intervalMinutes = msg.intervalMinutes || DEFAULTS.intervalMinutes;
    settings.playDurationSeconds = msg.playDurationSeconds || DEFAULTS.playDurationSeconds;
    ...
    chrome.storage.local.set({
      ...
      songMode: settings.songMode, // <-- FIX: Added this here to save it
